import { __awaiter, __generator, __read, __assign, __values } from 'tslib';
...
var UrlLoader = /** @class */ (function () {
        ...
        var executor = function (_a) {
            ...
            switch (method) {
                case 'GET':
                    ...
                    var validUrl = HTTP_URL.startsWith('http') ? HTTP_URL : dummyHostname + "/" + HTTP_URL;
    ...
    UrlLoader.prototype.getExecutorAndSubscriberAsync = function (pointer, options) {
        return __awaiter(this, void 0, void 0, function () {
            var fetch, headers, defaultMethod, extraHeaders, executor, subscriber, subscriptionsEndpoint, webSocketImpl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (options.useWebSocketLegacyProtocol) {
                            subscriber = this.buildWSLegacySubscriber(subscriptionsEndpoint, webSocketImpl, { headers: headers });
                        }
                        else {
                            subscriber = this.buildWSSubscriber(subscriptionsEndpoint, webSocketImpl, { headers: headers });
                        }
                        _a.label = 4;
